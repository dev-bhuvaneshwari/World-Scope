...
/**
 * WorldScope — Centralized SVG Vector Icon Library
 * Professional, crisp, lightweight icons with customizable size and color
 */

export function IconBase({ size = 18, className = '', children, viewBox = '0 0 24 24', ...props }) {
  return (
    <svg
      width={size}
      height={size}
